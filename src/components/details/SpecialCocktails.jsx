...
const SpecialCocktails = () => {
    ...
    return (
        <div className="flex flex-col">
            <p className="text-3xl md:text-2xl font-semibold md:font-bold my-8 md:my-4 mx-8 lg:my-6 lg:mx-12 md:text-left uppercase">{t(`side.moreHeader`)}</p>
            ...
            <div className="flex gap-2 md:gap-4 lg:gap-6 overflow-x-auto snap-x snap-mandatory scrollbar-hide sm:justify-center w-full px-4">
                {tikiCocktails.slice(0,3).map((value, index) => (
